...
import { TradeoffSlider } from '@/components/onboarding/TradeoffSlider'
...
const SESSION = ONBOARDING_SESSIONS[2]
    ...
    return (
      <div className="space-y-8 pt-4">
        ...
        <InsightReveal
          ...
          onResonate={() => router.push('/onboarding/session-4')}
          onNotQuite={() => router.push('/onboarding/session-4')}
        />
      </div>
    )
  }
